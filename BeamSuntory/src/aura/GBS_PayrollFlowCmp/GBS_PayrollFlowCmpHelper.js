    ...
    init: function (component, event, helper) {
        ...
        getPicklistValuesPromise.then(
            $A.getCallback(function (result) {
                ...
                helper.buildPicklistOptions(component, 'employeeLocationOptions', responseMap['employeeLocation']);
                helper.buildPicklistOptions(component, 'countryOfInterestOptions', responseMap['countryOfInterest']);
            })
        ).catch(
            function (error) {
                var errorDetail;
